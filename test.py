...
from models.mlv3 import FastDepth
...
def main():
    ...
    print("\n1. Define Model")
    # model = FastDepth(max_depth=args.max_depth, is_train=False).to(device)
    ...
    if args.dataset == 'imagepath': # not for do_evaluate in case of imagepath
        ...
        print("data_path1:", args.data_path)
    else:
    ...
    for batch_idx, batch in enumerate(test_loader):
        ...
        if args.save_eval_pngs:
            ...
            if args.dataset == 'nyudepthv2' or 'SUNRGBD':
        ...
        if args.save_visualize:
            ...
            pred_d_color = cv2.applyColorMap(pred_d_numpy, cv2.COLORMAP_JET)
